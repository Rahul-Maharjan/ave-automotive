...
const navItems = ["HOME", "ABOUT", "SERVICES", "CATEGORIES", "BLOG", "CONTACT"];
    ...
    <div className="min-h-screen bg-[#fafafa] text-[#111827]">
      <header className="relative z-20 bg-white/95 shadow-[0_1px_0_rgba(0,0,0,0.06)] backdrop-blur">
        <div className="mx-auto flex h-[110px] max-w-[1440px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-10">
          <a className="shrink-0" href="#home" aria-label="AVE Automotive home">
            <img
      ...
      >
        {/* <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.35)_0%,rgba(0,0,0,0.78)_48%,rgba(0,0,0,0.94)_100%)]" /> */}
